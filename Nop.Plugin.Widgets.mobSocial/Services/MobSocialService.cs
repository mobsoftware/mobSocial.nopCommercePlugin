...
namespace Nop.Plugin.Widgets.MobSocial.Services
{
    ...
    public class MobSocialService : IMobSocialService
    {
        ...
        public void SendProductReviewNotifications()
        {
            ...
            var orders = _orderService.SearchOrders(0, 0, 0, 0, 0, 0,0,null, DateTime.Now.AddYears(-5), null, OrderStatus.Complete, null, ShippingStatus.Delivered, null, null, null, 0);
