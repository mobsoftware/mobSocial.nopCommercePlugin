...
plugins.push(new webpack.optimize.CommonsChunkPlugin("init.js"));
if (minimize) {
...
module.exports = {
    ...
    entry: {
        ...
        essentials: [
            ...
            "./app/libraries/angucomplete-alt/angucomplete-alt.js",
            //jquery
            "./app/libraries/jQuery/jquery.signalR-2.2.1.min.js",
            //mentio
            ...
            "./app/scripts/app.js",
            "./app/scripts/common/services/oauthService.js",
        ...
        businessPage: [
            "./app/scripts/common/services/businessService.js",
            "./app/scripts/public/businesspages/businessController.js"
        ],
        teamPage: [
            "./app/scripts/common/services/teamPageService.js",
            "./app/scripts/public/teampages/teamPageController.js"
        ]
    },
    output: {
