...
namespace Nop.Plugin.Widgets.MobSocial.Core
{
    public interface IArtistPageService : IBaseService<ArtistPage, ArtistPagePicture>
    {
        ...
        IList<ArtistPage> GetArtistPagesByPageOwner(int PageOwnerId, string SearchTerm = "", int Count = 15, int Page = 1);
        IList<ArtistPage> GetArtistPagesByPageOwner(int PageOwnerId, out int TotalPages, string SearchTerm = "", int Count = 15, int Page = 1);
