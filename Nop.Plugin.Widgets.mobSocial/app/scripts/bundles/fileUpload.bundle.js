...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	(function (angular, factory) {
	    if (true) {
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(26)], __WEBPACK_AMD_DEFINE_RESULT__ = function (angular) {
...
/***/ (function(module, exports) {
	...
	window.mobSocial.lazy.directive("fileUploadButton", ['FileUploader', '$compile', '$timeout', "globalApiEndPoint", "oauthService", function (FileUploader, $compile, $timeout, globalApiEndPoint, oauthService) {
	    return {
	        restrict: 'A',
	        scope: false,
	        link: function (scope, elem, attrs) {
	            //gather attributes
	            var url = globalApiEndPoint + attrs.url;
