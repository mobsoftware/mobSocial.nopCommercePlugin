app.directive("customField", ['customFieldService', '$window', 'customFieldProvider', "$timeout", "$compile", function (customFieldService, $window, customFieldProvider, $timeout, $compile) {
    return {
        restrict: "E",
        templateUrl: "CustomField/CustomField",
        replace: true,
        scope: {
